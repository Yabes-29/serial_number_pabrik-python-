...
class MrpSerialNumber(models.Model):
	...
	part_request_ids = fields.One2many('mrp.part.request.serial', 'part_request_id', string="Material Request Line")
	...
	def action_fill_part_request_lines(self):
		for req in self:
			part_line_obj = self.env['mrp.part.request.serial']
...
class MrpPartRequestSerial(models.Model):
	_name = 'mrp.part.request.serial'
